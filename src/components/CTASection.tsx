    ...
    <section id="cta" className="py-20 border-t border-white/5">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mt-8 grid sm:grid-cols-2 gap-4">
          ...
          <a href="mailto:invest@secureaudit.io?subject=Investor%20Deck" className="px-6 py-4 rounded-lg bg-brand-500 hover:bg-brand-400 text-white font-medium gradient-border">Request Investor Deck</a>
        </div>
