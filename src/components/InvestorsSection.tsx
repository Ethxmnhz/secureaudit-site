        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="glass rounded-2xl p-6 border border-white/10">
            <div className="grid grid-cols-2 gap-4">
              {[
                ['Stage', 'Private beta'],
                ['Differentiator', 'Active control validation'],
                ['Compliance fit', 'NIST / ISO alignment'],
                ['Materials', 'Deck + demo on request'],
              ].map(([k, v]) => (
            ...
            <a href="#cta" className="mt-6 inline-flex items-center justify-center w-full rounded-lg bg-brand-500 hover:bg-brand-400 text-white py-3 font-medium">Request Investor Deck</a>
            <p className="mt-3 text-center text-xs text-slate-400">Fundraising details available upon request.</p>
          </div>
        </div>
      </div>
    </section>
